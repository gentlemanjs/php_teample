...
<main id="contents">
        ...
        <section class="join-type gray">
            <div class="member-form">
                ...
                <div class="mb50 blue">
                    <ul class="list">
                        <li>목적: 가입자 개인 식별, 가입 의사 확인, 가입자와의 원활한 의사소통, 가입자와의 교육 커뮤니 케이션</li>
                    ...
                    <fieldset>
                        ...
                        <div class="join-box">
                            <div class="overlap">
                                ...
                                <input type="text" id="youEmail" name="youEmail" placeholder="Sample@naver.com" autocomplete="off">
                                <a href="#a" class="test" onclick="emailChecking();">중복검사</a>
                            ...
                            <div class="overlap">
                                ...
                                <a href="#a" class="test" onclick="nickChecking();">중복검사</a>
                                <p class="comment" id="youNickNameComment"></p>
                            </div>
                            <div class="basic">
                                <label for="youPass">비밀번호</label>
                                <input type="password" id="youPass" name="youPass" placeholder="비밀번호를 적어주세요!" autocomplete="off">
                                <p class="comment" id="youPassComment"></p>
                            </div>
                            <div class="basic">
                                <label for="youPassC">비밀번호 확인</label>
                                <input type="password" id="youPassC" name="youPassC" maxlength="20" placeholder="비밀번호를 다시 적어주세요!" autocomplete="off">
                            ...
                            <div class="basic">
                                ...
                                <input type="text" id="youBirth" name="youBirth" maxlength="12"placeholder="YYYY-MM-DD" autocomplete="off">
                                <p class="comment" id="youBirthComment"></p>
                            </div>
                            <div class="basic">
                                <label for="youPhone">휴대폰 번호</label>
                                <input type="text" id="youPhone" name="youPhone" maxlength="15" placeholder="000-0000-0000" autocomplete="off">
...
<script>
    ...
    function joinChecks(){
        ...
        if(!getBirth.test($("#youBirth").val())){
            $("#youBirthComment").text("YYYY-MM-DD 형식을 확인해주세요!");
            $("#youBirthComment").val("");
            return false;
        }
